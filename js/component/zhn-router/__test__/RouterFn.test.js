...
describe("parsePath", () => {
  ...
  test("should parse a complex pathname with special characters", () => {
    expect(fn("/items/props/about")).toEqual({
      pathname: "/items/props/about"
    });
    expect(fn("/a-b_name/sub-path")).toEqual({
      pathname: "/a-b_name/sub-path"
    });
    expect(fn("/items/props/123")).toEqual({
      pathname: "/items/props/123"
    });
  });
