...
exports.Routes = exports.Router = exports.Route = exports.Navigate = exports.NavLink = void 0;
...
const Router = ({
  ...
  const basename = (0, _RouterFn.normalizeLeadingSlash)(basenameProp),
...
const parseToInfo = (_to, basename) => {
  let to = _to;
...
const useResolvedPath = to => {
  ...
  isModifiedEvent = evt => !!(evt.metaKey || evt.altKey || evt.ctrlKey || evt.shiftKey),
